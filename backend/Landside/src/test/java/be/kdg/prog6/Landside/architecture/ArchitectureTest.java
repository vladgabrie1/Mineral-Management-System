package be.kdg.prog6.Landside.architecture;
...
public class ArchitectureTest {
    ...
    private static final String ADAPTER_LAYER = "be.kdg.prog6.Landside.adapters..";
    private static final String CORE_LAYER = "be.kdg.prog6.Landside.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.Landside.ports..";
    ...
    // Defines the relationships between multiple layers (adapters, ports, core) and verifies that they follow correct dependency rules.
    @Test
